    ...
    feedbacks: [
      {
        ...
        imgs: [ { src: "../assets/tumeurs/level5/q1_rep_a.png", title: "Myxoid tumor", source: "./data/level5Questions.js:15" }],
      },
      {
        ...
        imgs: [
          { src: "../assets/tumeurs/level5/q1_rep_b1.png", title: "Fusiform tumor", source: "./data/level5Questions.js:33" },
          { src: "../assets/tumeurs/level5/q1_rep_b2.png", title: "Fusiform tumor", source: "./data/level5Questions.js:49" },
        ],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q1_rep_c.png", title: "Round cell tumor", source: "./data/level5Questions.js:66" }],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q1_rep_d.png", title: "Pleomorphic tumor", source: "./data/level5Questions.js:82" }],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q1_rep_e.png", title: "Épithelioid tumor", source: "./data/level5Questions.js:98" }],
      },
    ],
  },
  q2: {
    ...
    feedbacks: [
      {
        ...
        imgs: [ 
          { src: "../assets/tumeurs/level5/q2_rep_a1.png", title: "Tubular pattern", source: "./data/level5Questions.js:117" },
          { src: "../assets/tumeurs/level5/q2_rep_a2.png", title: "Tubular pattern", source: "./data/level5Questions.js:134" },
        ],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q2_rep_b.png", title: "Lobular pattern", source: "./data/level5Questions.js:151" }],
      },
      {
        text: "Oups! It is not a nested pattern. A nested pattern is characterized by packets or groups of cells separated by stroma. Pheochromocytoma: nested pattern.",
        imgs: [
          { src: "../assets/tumeurs/level5/q2_rep_c1.png", title: "Nested pattern", source: "./data/level5Questions.js:168" },
          { src: "../assets/tumeurs/level5/q2_rep_c2.png", title: "Nested pattern", source: "./data/level5Questions.js:168" },
        ],
      },
      {
        ...
        imgs: [ { src: "../assets/tumeurs/level5/q2_rep_d.png", title: "Solid pattern", source: "./data/level5Questions.js:184" }],
      },
      {
        ...
        imgs: [
          { src: "../assets/tumeurs/level5/q2_rep_e1.png", title: "Trabecular pattern", source: "./data/level5Questions.js:201" },
          { src: "../assets/tumeurs/level5/q2_rep_e2.png", title: "Trabecular pattern", source: "./data/level5Questions.js:218" },
        ],
      },
    ],
  },
    ...
    feedbacks: [
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q3_rep_a.png", title: "Collagenous stroma", source: "./data/level5Questions.js:236" }],
      },
      {
        text: "Yes! it is a vascular stroma. Our case: blood lakes and extensive haemorrhage.",
        imgs: [{ src: "../assets/tumeurs/level5/q3_rep_b.png", title: "Vascular stroma", source: "./data/level5Questions.js:253" }],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q3_rep_c.png", title: "Myxoïd stroma", source: "./data/level5Questions.js:270" }],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q3_rep_d.png", title: "Coagulative tumor necrosis", source: "./data/level5Questions.js:287" }],
      },
      {
        text: "Oups! it is not a scant stroma. Leiomyosarcoma: scant stroma.",
        imgs: [{ src: "../assets/tumeurs/level5/q3_rep_e.png", title: "Scant stroma", source: "./data/level5Questions.js:304" }],
      },
    ],
  },
  q4: {
    ...
    feedbacks: [
      {
        ...
        imgs: [
          { src: "../assets/tumeurs/level5/q4_rep_a1.png", title: "Indistinct cell borders", source: "./data/level5Questions.js:337" },
          { src: "../assets/tumeurs/level5/q4_rep_a2.png", title: "Indistinct cell borders", source: "./data/level5Questions.js:354" },
        ],
      },
      {
        text: "Yes! the Cytoplasm is abundant, eosinophilic. Our case: Cytoplasm is abundant, eosinophilic.",
        imgs: [{ src: "../assets/tumeurs/level5/q4_rep_b.png", title: "Eosinophilic cytoplasm", source: "./data/level5Questions.js:362" }],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q4_rep_c.png", title: "Rhabdoid cells", source: "./data/level5Questions.js:387" }],
      },
      {
        text: "Yes! cells present distinct nucleoli. Our case: prominent nucleoli.",
        imgs: [{ src: "../assets/tumeurs/level5/q4_rep_d.png", title: "Distinct nucleoli", source: "./data/level5Questions.js:412" }],
      },
      {
    ...
    feedbacks: [
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q5_rep_a.png", title: "AE1/AE3", source: "./data/level5Questions.js:441" }],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q5_rep_b.png", title: "EMA", source: "./data/level5Questions.js:458" }],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q5_rep_c.png", title: "CD31", source: "./data/level5Questions.js:472" }],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q5_rep_d.png", title: "S100", source: "./data/level5Questions.js:490" }],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q5_rep_e.png", title: "Desmin", source: "./data/level5Questions.js:506" }],
      },
    ],
  },
  q6: {
    ...
    feedbacks: [
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q6_rep_a.png", title: "Extrarenal rhabdoid tumour", source: "./data/level5Questions.js:528" }],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q6_rep_b.png", title: "Epithelioid sarcoma", source: "./data/level5Questions.js:553" }],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q6_rep_c.png", title: "Epithelioid hemangioma", source: "./data/level5Questions.js:566" }],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q6_rep_d.png", title: "Malignant peripheral nerve sheath tumour", source: "./data/level5Questions.js:581" }],
      },
      {
        ...
        imgs: [{ src: "../assets/tumeurs/level5/q6_rep_e.png", title: "Epithelioid angiosarcoma", source: "./data/level5Questions.js:597" }],
      },
    ],
  },
};
