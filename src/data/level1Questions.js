export const level1Questions = {
  q1: {
    ...
    feedbacks: [
      {
        text: "Good job! It is a myxoid tumor. A myxoid tumor is characterised by a gelatinous material produced by soft tissue cells. It resembles epithelial mucin, but is not as thick (looks like watered-down mucin – it is not as blue or stringy).",
        imgs: [],
      },
      {
    ...
    feedbacks: [
      {
        ...
        imgs: ["../assets/tumeurs/level1/q2_rep_a.png"],
      },
      {
        ...
        imgs: ["../assets/tumeurs/level1/q2_rep_b.png"],
      },
      {
        ...
        imgs: ["../assets/tumeurs/level1/q2_rep_c1.png","../assets/tumeurs/level1/q2_rep_c2.png"],
      },
      {
      ...
      },
      {
        ...
        imgs: ["../assets/tumeurs/level1/q2_rep_e.png"],
      },
    ],
  },
  q3: {
    ...
    feedbacks: [
      ...
      },
      {
        ...
        imgs: ["../assets/tumeurs/level1/q3_rep_b.png"],
      },
      {
  ...
  q5: {
    ...
    feedbacks: [
      ...
      },
      {
        ...
        imgs: ["../assets/tumeurs/level1/q5_rep_d1.png", "../assets/tumeurs/level1/q5_rep_d2.png", "../assets/tumeurs/level1/q5_rep_d3.png", "../assets/tumeurs/level1/q5_rep_d4.png"],
      },
      {
        ...
        imgs: ["../assets/tumeurs/level1/q5_rep_e.jpeg"],
      },
    ],
  },
};